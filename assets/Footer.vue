<template>
  <footer class="footer">
    ...
    <div class="stats">
      絳雪生涼<span id="vercount_value_site_pv">❄️</span>碧霞籠夜 , 小立中庭<span id="vercount_value_site_uv">☃️</span>蕪地
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      blogUrl: "https://1766666.xyz/blog",
      githubUrl: "https://github.com/lifevibe",
